...
class SignalAnalysis():
    ...
    def match_signals(sweep_signal, reference_signal):
        ...
        return matched_sweep_signal, matched_reference_signal
    ...
    def find_correlation(sweep_signal,reference_signal):
        ...
        matched_sweep_signal, matched_reference_signal = SignalAnalysis.match_signals(sweep_signal_window['y'], reference_signal_window['y'])
