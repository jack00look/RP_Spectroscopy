#rom GettingStarted_lib.Interface import Interface
...
from GettingStarted_lib.data_handler_new import DataHandler
...
class LaserLockingController():
    ...
    def __init__(self, interface):
        ...
        self.log_file = Path(__file__).parent / f"logs/{interface.board.name}_LaserLockingController.log"
        setup_logging(self.logger, self.log_file)
        self.lock_unlock_logger = logging.getLogger("LockUnlockEventsLogger")
        setup_logging(self.lock_unlock_logger, Path(__file__).parent / f"logs/{interface.board.name}_LockUnlockEvents.log")

        self.hardware_interface = interface
        self.data_handler = DataHandler(interface.board)
