...
from PySide6.QtWidgets import (QApplication, QMainWindow, QVBoxLayout, 
                               QPushButton, QLabel, QWidget, QTextEdit, QLineEdit)
...
class LaserLockController(QObject):
    ...
    def start_auto_lock(self, line_name):
        """
        Slot receives signal from GUI or RPC.
...
class MainWindow(QMainWindow):
    # --- CUSTOM SIGNALS ---
    # The GUI emits these. It doesn't know WHO receives them.
    # This is the "Pure Signal" approach.
    sig_request_lock = Signal(str)
    sig_request_stop = Signal()

    def __init__(self):
        super().__init__()
        self.setWindowTitle("Laser Control (Decoupled Architecture)")
        self.resize(600, 400)
        ...
        # Connect button clicks to internal methods that emit signals
    ...
    def on_lock_clicked(self):
        ...
        if line_name:
            ...
            # Emit the signal to the void (Coordinator will catch it)
